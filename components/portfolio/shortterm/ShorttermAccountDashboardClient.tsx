...
export function ShorttermAccountDashboardClient() {
  ...
  const derivedTrades = useMemo((): EducationTrade[] => {
    // 잔량=0인 종목 단위로 집계 — Longterm/Education과 동일한 balance=0 방식으로 통일
    ...
    for (const [, g] of groupMap) {
      ...
      // positions 기준 잔량 확인 (미로드 시 거래 합산으로 대체)
      ...
      <Tabs defaultValue="positions">
        ...
        <TabsContent value="positions" className="mt-4 space-y-3">
          ...
          <LongtermPositionsTable
            ...
            onAccountFilterChange={(v) => setPosAcct(v as "all" | "4802" | "1635" | "1402" | "2805" | "1470")}
          />
        </TabsContent>
