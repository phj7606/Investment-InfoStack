/**
 * GET    /api/portfolio/shortterm/positions       — 보유 포지션 목록 반환
 * POST   /api/portfolio/shortterm/positions       — 새 포지션(매수) 추가
 * PUT    /api/portfolio/shortterm/positions       — 포지션 편집
 * DELETE /api/portfolio/shortterm/positions?id=  — 포지션 삭제
 */
